...
app.get('/', (req, res) => res.json({
  status: '🌸 SkinBloom Bot running', version: '2.9.0',
...
app.listen(PORT, async () => {
  console.log(`🌸 SkinBloom Bot v2.9.0 listening on port ${PORT}`);
  await registerTelegramWebhook();
  await sendTelegram('🌸 <b>SkinBloom Bot v2.9.0 асаалаа!</b>\n\n🆕 <b>Шинэчлэлт (v2.9.0 — бүтээгдэхүүний canon):</b>\n✅ KDF бүрэн устгасан — шинэ РАДИАЛ 3 давхар бүтэц\n   (PP бүрхүүл → Active Carbon → Нягтаршуулсан PP цөм)\n✅ "Хүнд металл", "бактер" claim хориглов\n✅ Нөөц шүүлтүүрийн promo 09.01 хүртэл сунгав\n✅ Өнгөний тайлбар Shopify-тай нэг мөр болов\n✅ Шинэ загвар: "Шүүлтүүр яаж ажилладаг вэ?"\n\n<b>Командууд:</b>\n<code>/help</code> — бүх команд\n<code>/list</code> — handoff list\n<code>/release [id]</code> — handoff унтраах\n<code>/send [id] [1|2|3]</code> — draft илгээх\n<code>/dm [id] [text]</code> — гар мессеж\n<code>/draft [id]</code> — шинэ draft');
});
