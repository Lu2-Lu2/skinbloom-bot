...
// =====================================================================
// ДЕТЕРМИНИСТИК ХАРИУЛТЫН ТЕКСТ (NEW v2.9.3, өргөтгөсөн v2.9.5)
// ---------------------------------------------------------------------
...
// =====================================================================
// 1) ҮНЭ асуусан үед — зөвхөн ЭХНИЙ удаагийн hook (v2.9.7, hook солигдсон v2.9.9)
const PRICE_ANSWER = `Филтертэй Шүршүүр 269'000₮ ➜ 199'900₮ 🔥
🧴 Active Carbon Filter — давхар бүрээр дамжин шүүх механизм
💧 Хлорын нэгдэл, шохойн үлдэгдэл, зэв, бактерийн болон хүнд металлын үлдэгдэл
🎁 Brush + Donut Sponge бэлэг · 🚚 Хүргэлт үнэгүй · 🎨 3 өнгө
...
const BUNDLE_DETAIL_ANSWER = `💎 Яагаад 199'900₮ гэж?
🧴 Active Carbon Filter — давхар бүрээр дамжин шүүх механизм.
Бохир ус — бариул доторх 3 давхар нарийн технологийн дагуу цэвэр усыг гаргана:
1️⃣ PP бүрхүүл — элс, тунадас, зэв
2️⃣ Шахмал Active Carbon хана — хлорын нэгдэл, эвгүй үнэр
3️⃣ Нягтаршуулсан PP цөм — шохойн үлдэгдэл, нарийн бохирдол
Шүүгдэх зүйл: хлорын нэгдэл, шохойн үлдэгдэл, зэв, тунадас, эвгүй үнэр,
бактерийн болон хүнд металлын үлдэгдэл 🌸
🚿 Премиум шүршүүр — 40% ус хэмнэнэ, спа даралт
Нийт үнэлгээ: 269'000₮ ➜ 199'900₮ · 69'100₮ хэмнэлт
✨ Өдөрт ~548₮ — арьсанд хүрэх усаа солино
🎁 Brush (24'500₮) + Donut Sponge (24'500₮) — бэлэг
🚚 Хүргэлт үнэгүй
🎨 🤍 Pearl White · 🩶 Slate Gray · ⬛ Obsidian Black
Аль өнгийг сонгох уу? 🌸`;
// 1c) ШҮРШҮҮР/БАГЦ АВАХ интент — өнгө сонгуулах (NEW v2.9.6)
const BUNDLE_COLOR_ASK = `Тэгье 🌸 Бэлгийн Багц — 199'900₮
🧴 Давхар бүрээр дамжин шүүх механизм — бохир уснаас цэвэр ус
⬛ Obsidian Black — мөнгөлөг цагираг, premium гүн хар
🤍 Pearl White — дулаан гэрэлтэй, цэвэр цайвар
🩶 Slate Gray — час улаан дотоод цагираг
Бүх өнгөнд ижил үнэ, ижил шүүлт. Та аль өнгийг сонгох вэ?`;
...
🧴 Active Carbon Filter шүршүүрт суурилуулсан ирнэ — хлорын нэгдэл, шохойн үлдэгдэл, зэв, усны бохирдол.
🎁 Brush + Donut Sponge бэлэг
🚚 Хүргэлт үнэгүй
...
// 8) ШҮҮЛТҮҮР ЯАЖ АЖИЛЛАДАГ — LLM руу унагахгүй (NEW v2.9.9)
const FILTER_MECHANISM_ANSWER = `🧴 SkinBloom — давхар бүрээр дамжин шүүх механизм 💧
Бохир ус — бариул доторх 3 давхар нарийн технологийн дагуу цэвэр усыг гаргана:
1️⃣ PP бүрхүүл — элс, тунадас, зэв
2️⃣ Шахмал Active Carbon хана — хлорын нэгдэл, эвгүй үнэр
3️⃣ Нягтаршуулсан PP цөм — шохойн үлдэгдэл, нарийн бохирдол
Шүүгдэх зүйл: хлорын нэгдэл, шохойн үлдэгдэл, зэв, тунадас, эвгүй үнэр,
бактерийн болон хүнд металлын үлдэгдэл 🌸
Гурван шатыг дамжсаны дараа л ус арьсанд хүрнэ.`;
// 9) ҮНЭ ЭСЭРГҮҮЦЭЛ — "яагаад ийм үнэтэй" (NEW v2.9.9)
const PRICE_VALUE_ANSWER = `199'900₮ бол хуванцар шүршүүр биш 🌸
Бохир ус — бариул доторх 3 давхар нарийн технологийн дагуу цэвэр усыг гаргана.
Хлорын нэгдэл, шохойн үлдэгдэл, зэв, бактерийн болон хүнд металлын үлдэгдлийг барина.
Өдөрт ~548₮. Суулгаад л ажиллана.
69'100₮ хэмнэлт + 2 бэлэг + хүргэлт үнэгүй.
Аль өнгийг харах уу?`;
...
// ── ШҮҮЛТҮҮРИЙН МЕХАНИЗМ / ЮУ ШҮҮДЭГ (NEW v2.9.9) ──
// LLM руу унагавал "устгана / 99% / эмчилнэ" гэж хальдаг тул JS барина.
const MECHANISM_STEMS = [
  'ажиллад', 'azhillad', 'ajillad', 'ажиллах',
  'бүтэц', 'butets', 'bvtec',
  'яаж шүү', 'yaaj shuu', 'яаж шуу',
  'юу шүү', 'yuu shuu', 'yu shuu',
  'юуг шүү', 'yuug shuu',
  'шүүдэг', 'shuudeg', 'shuudeg',
  'шүүх үү', 'shuuh uu',
  'ямар бохир', 'yamar bohir',
  'хлор', 'hlor', 'chlor',
  'бактер', 'bakter', 'bacter', 'bacterial',
  'хүнд металл', 'hund metall', 'hvnd metall', 'heavy metal',
  'шохой', 'shohoi', 'limescale',
  'зэв', 'zev', 'zevtei'
];
function isFilterMechanismQuestion(text) {
  if (!text) return false;
  if (isPriceQuestion(text) || isBuyIntent(text)) return false;
  if (isDirectInfoRequest(text) && !hasAnyStem(text, MECHANISM_STEMS)) return false;
  return hasAnyStem(text, MECHANISM_STEMS) || hasAnyPhrase(text, [
    'яаж ажиллад', 'yaaj ajillad', 'юу шүүдэг', 'yuu shuudeg',
    'юуг шүүдэг', 'filter how', 'how it works'
  ]);
}
// ── ҮНЭ ЦЭНИЙН ЭСЭРГҮҮЦЭЛ (NEW v2.9.9) ──
// "яагаад ийм үнэтэй" ≠ хямдрал нэмэх. Handoff биш — value signal.
const PRICE_VALUE_PHRASES = [
  'яагаад үнэтэй', 'яагаад ийм үнэ', 'яагаад ийм үнэтэй',
  'яагаад 199', 'яагаад 200', 'юундоо үнэтэй',
  'унэтэй юм', 'үнэтэй юм', 'үнэтэй шд',
  'яагаад энэ үнэ', 'яагаад төгрөг',
  'yagaad unetei', 'yagaad iim une', 'yagaad 199', 'yagaad 200',
  'why so expensive', 'why expensive'
];
function isPriceValueQuestion(text) {
  if (!text) return false;
  if (isPriceManipulation(text)) return false;
  const t = normWords(text);
  return PRICE_VALUE_PHRASES.some(p => t.includes(p) || String(text).toLowerCase().includes(p));
}
...
- "KDF", "устгана", "ариутгана", "99%", "эмчилнэ", "экзем" — эдгээр ХЭЗЭЭ Ч бичихгүй
- Шүүлтийн зөвшөөрөгдсөн үгс л хэрэглэ: хлорын нэгдэл, шохойн үлдэгдэл, зэв, тунадас, эвгүй үнэр, бактерийн үлдэгдэл, хүнд металлын үлдэгдэл
...
// =====================================================================
// SYSTEM PROMPT v2.9.9 — 2026.09.24
// v2.9.8 → v2.9.9: үнийн hook = Active Carbon + шүүлтийн жагсаалт.
// Шүүлтийн зөвшөөрөгдсөн үгс: хлорын нэгдэл, шохойн үлдэгдэл, зэв,
// бактерийн үлдэгдэл, хүнд металлын үлдэгдэл. "устгана/эмчилнэ" хориотой.
// ---------------------------------------------------------------------
// SYSTEM PROMPT v2.9.5 — 2026.08.09
// v2.9.4 → v2.9.5 ӨӨРЧЛӨЛТ (Lu2-ын хүсэлт):
//
// 1️⃣ БАГЦЫН ДЭЛГЭРЭНГҮЙ — шинэ value-stack (💎 2 үндсэн + 2 бэлэг).
//    Тогтмол текст `BUNDLE_DETAIL_ANSWER`-т байна, LLM давтахгүй.
//
// 2️⃣ ⛔ БАГЦЫН ТАЙЛБАРААС НӨӨЦ ШҮҮЛТҮҮРИЙН ҮНЭ (44'900₮ / 29'900₮) БҮРЭН
//    САЛГАВ. Тусдаа зарагддаг шүүлтүүрийн үнийг ЗӨВХӨН хэрэглэгч
//    шүүлтүүрийн талаар тусгайлан асуусан үед л өгнө. GUARD #5 хатуу хамгаална.
//
// 3️⃣ Дэлгүүр `https://skinbloom.store/`, утас `99076895, 95999989` (хоёулаа).
// ---------------------------------------------------------------------
// v2.9.4 (хэвээр): үнийн асуулт LLM руу унахгүй, markdown авто-цэвэрлэгээ,
//                 6 цагийн stale-context цэвэрлэгээ.
// v2.9.3 (хэвээр): үнийн hook JS-д, шүүлтүүрийн тодруулга, Twin/Family устгав,
//                 Латин бичлэг таних, Герман гарал үүсэл.
...
▸ 🔬 ШҮҮЛТҮҮРИЙН БҮТЭЦ — ДАВХАР БҮРЭЭР ДАМЖИН ШҮҮХ МЕХАНИЗМ (радиал, 2026.07 задалгаа)
  Хэрэглэгчид "радиал" гэж бичихгүй. Зөвхөн: "давхар бүрээр дамжин шүүх механизм".
  Урсгалыг ингэж ярина: "Бохир ус — бариул доторх 3 давхар нарийн технологийн дагуу цэвэр усыг гаргана."
  Дотоод физик (хэрэглэгчид ярихгүй): гаднаас дотогшоо 3 давхар → голын сувгаар дээшээ → толгой.
  ...
  • ✅ ЗӨВШӨӨРӨГДСӨН ШҮҮЛТИЙН ЖАГСААЛТ (яг энэ үгс, өөр юу ч нэмэхгүй):
    хлорын нэгдэл, шохойн үлдэгдэл, зэв, тунадас, эвгүй үнэр,
    бактерийн үлдэгдэл, хүнд металлын үлдэгдэл, усны бохирдол
  • ⛔ "устгана", "ариутгана", "99%", "бүрэн цэвэрлэнэ", "эмчилнэ",
    "экзем", "харшил арилгана" — ХЭЗЭЭ Ч бичихгүй.
  • ⛔ Хувиар / лабораторийн тоо / өвчин эмгэгийн нэр зохиож болохгүй.
...
⚠️ Үүнийг JS код өөрөө явуулна. Хэрэв чам дээр ирвэл ЗӨВХӨН:
"🧴 SkinBloom — давхар бүрээр дамжин шүүх механизм 💧
Бохир ус — бариул доторх 3 давхар нарийн технологийн дагуу цэвэр усыг гаргана:
1️⃣ PP бүрхүүл — элс, тунадас, зэв
2️⃣ Шахмал Active Carbon хана — хлорын нэгдэл, эвгүй үнэр
3️⃣ Нягтаршуулсан PP цөм — шохойн үлдэгдэл, нарийн бохирдол
Шүүгдэх зүйл: хлорын нэгдэл, шохойн үлдэгдэл, зэв, тунадас, эвгүй үнэр, бактерийн болон хүнд металлын үлдэгдэл 🌸"
...
• ⛔ Хятад / Япон / Солонгос / Made in China ХЭЗЭЭ Ч дурдахгүй
• CE сертификат: HX240303050484
• Filter бүтэц — давхар бүрээр дамжин шүүх механизм. Хэрэглэгчид "радиал" бичихгүй.
• Усны урсгал (хэрэглэгчид ярих өгүүлбэр): "Бохир ус — бариул доторх 3 давхар нарийн технологийн дагуу цэвэр усыг гаргана."
• Дотоод физик: PP нэхмэл бус бүрхүүл → Active Carbon шахмал цагираг хана → Нягтаршуулж Сайжруулсан PP цөм → голын сувгаар дээшээ → oval толгой
• ⛔ KDF БАЙХГҮЙ. Металл тор БАЙХГҮЙ. Ceramic БИШ — "ceramic" гэж хэзээ ч хэлэхгүй
• ✅ Шүүлт: хлорын нэгдэл, шохойн үлдэгдэл, зэв, тунадас, эвгүй үнэр, бактерийн болон хүнд металлын үлдэгдэл
• ⛔ "устгана / ариутгана / 99% / эмчилнэ / экзем" — ХЭЗЭЭ Ч бичихгүй
...
❌ "бактер устгана" / "ариутгана" / "99%" / "эмчилнэ" → ✅ "бактерийн үлдэгдэл, хүнд металлын үлдэгдэл, хлорын нэгдэл, шохойн үлдэгдэл"
❌ Үнийн хариуг зөвхөн бэлэг/хүргэлт/өнгөөр эхлүүлэх → ✅ эхлээд Active Carbon Filter + юу шүүнэ, дараа нь бэлэг
...
• "KDF", "устгана", "ариутгана", "99%", "эмчилнэ" гэж ХЭЗЭЭ Ч бичихгүй
• Шүүлт дурдах бол: хлорын нэгдэл, шохойн үлдэгдэл, зэв, бактерийн болон хүнд металлын үлдэгдэл
...
app.post('/webhook', async (req, res) => {
  ...
  for (const entry of (body.entry || [])) {
    ...
    for (const event of (entry.messaging || [])) {
      ...
      // ═══════════════════════════════════════════════════════
      // 9b) ҮНЭ ЦЭНЭ — "яагаад ийм үнэтэй" (NEW v2.9.9)
      // ═══════════════════════════════════════════════════════
      if (isPriceValueQuestion(text)) {
        console.log(`💎 Price-value question [${senderId}]: ${text.slice(0, 60)}`);
        addToHistory(senderId, 'user', text);
        addToHistory(senderId, 'assistant', PRICE_VALUE_ANSWER);
        await sendDM(senderId, PRICE_VALUE_ANSWER);
        markGreeting(senderId);
        continue;
      }
      // ═══════════════════════════════════════════════════════
      // 9c) ШҮҮЛТҮҮР ЯАЖ АЖИЛЛАДАГ / ЮУ ШҮҮДЭГ (NEW v2.9.9)
      // LLM руу унагахгүй — claim хальтыг энд хаана.
      // ═══════════════════════════════════════════════════════
      if (isFilterMechanismQuestion(text)) {
        console.log(`🔬 Filter mechanism [${senderId}]: ${text.slice(0, 60)}`);
        addToHistory(senderId, 'user', text);
        addToHistory(senderId, 'assistant', FILTER_MECHANISM_ANSWER);
        await sendDM(senderId, FILTER_MECHANISM_ANSWER);
        markGreeting(senderId);
        continue;
      }
      // ═══════════════════════════════════════════════════════
      ...
      try {
        ...
        // ── v2.9.9 GUARD #7: ЭМНЭЛГИЙН / ХЭТРҮҮЛСЭН CLAIM ──
        // Зөвшөөрөгдсөн: "бактерийн үлдэгдэл", "хүнд металлын үлдэгдэл".
        // Хориотой: устгана, ариутгана, 99%, эмчилнэ, экзем, харшил арилгана.
        if (/устгана|ариутгана|стериль|99\s*%|98\s*%|эмчилнэ|эдгээнэ|экзем|eczema|харшил арилга|антибактер|antibacter/i.test(cleanReply)) {
          console.log(`🛑 GUARD#7 medical/overclaim таслав [${senderId}]`);
          cleanReply = FILTER_MECHANISM_ANSWER;
        }
...
app.get('/', (req, res) => res.json({
  status: '🌸 SkinBloom Bot running', version: '2.9.9',
...
app.listen(PORT, async () => {
  console.log(`🌸 SkinBloom Bot v2.9.9 listening on port ${PORT}`);
  await registerTelegramWebhook();
  await sendTelegram('🌸 <b>SkinBloom Bot v2.9.9 асаалаа!</b>\n\n🔧 <b>v2.9.9:</b>\n✅ Үнийн hook — Active Carbon Filter + шүүлтийн жагсаалт эхэнд\n✅ Шүүгдэх зүйл: хлорын нэгдэл, шохойн үлдэгдэл, зэв, бактерийн/хүнд металлын үлдэгдэл\n✅ "яагаад үнэтэй" → value signal (handoff биш)\n✅ Шүүлтүүр яаж ажилладаг → JS тогтмол хариу (LLM хальтыг хаав)\n🛑 GUARD #7 — устгана/эмчилнэ/99%/экзем хориглоно\n\n🔧 <b>v2.9.8:</b>\n✅ Гарал үүсэл — CE + Хонгконг үйлдвэр\n✅ Мэндчилгээнд стикер\n\n<b>Командууд:</b>\n<code>/help</code> — бүх команд\n<code>/list</code> — handoff list\n<code>/release [id]</code> — handoff унтраах\n<code>/send [id] [1|2|3]</code> — draft илгээх\n<code>/dm [id] [text]</code> — гар мессеж\n<code>/draft [id]</code> — шинэ draft');
});
